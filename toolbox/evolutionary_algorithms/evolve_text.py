...
def two_point_crossover(par1, par2):
	for i in range(min(len(par1), len(par2))):
...
def get_toolbox(text):
	...
	# register each Message as an individual in the population,
	# then register a (repeatedly initialized) list of inidividuals as the population
